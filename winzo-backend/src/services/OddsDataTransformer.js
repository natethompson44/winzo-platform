  ...
  static getTeamLogo(teamName, sport) {
    ...
    const teamMappings = {
      ...
      soccer: {
        ...
        'Man City': '/images/clubs/epl/manchester-city.png',
        'Man United': '/images/clubs/epl/manchester-united.png',
        'Man Utd': '/images/clubs/epl/manchester-united.png',
        'Manchester Utd': '/images/clubs/epl/manchester-united.png',
        ...
        'PSG': '/images/clubs/ligue1/paris-saint-germain.png',
        'Olympique Marseille': '/images/clubs/ligue1/olympique-marseille.png',
