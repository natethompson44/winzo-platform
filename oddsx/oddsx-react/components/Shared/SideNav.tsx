    ...
    return (
        <>
            <ul className="secend-actives bg1-color rounded-5 d-flex flex-column gap-5 mb-5">
                <li className="active">
                    <NoPrefetchLink href="/" className="d-flex align-items-center gap-2"><i
                        className="ti ti-brand-google-home n5-color fs-five"></i> Home</NoPrefetchLink>
                </li>
                <li className="active">
                    <NoPrefetchLink href="#" className="d-flex align-items-center gap-2"><i
                        className="ti ti-garden-cart n5-color fs-five"></i>
                        Marketplace</NoPrefetchLink>
                </li>
                <li className="active">
                    <NoPrefetchLink href="/efighting" className="d-flex align-items-center gap-2"><svg
            ...
            <ul className="aside_namelist d-flex flex-column gap-2">
                {popularData.map((popularSingle) => (
                    <li
                        ...
                        <NoPrefetchLink href={popularSingle.href} className="d-flex align-items-center gap-2"><Image
                            width={16} height={16} src={popularSingle.image} alt="icon" />{popularSingle.linkText}</NoPrefetchLink>
            ...
            <ul className="aside_namelist d-flex flex-column gap-2 mb-15">
                {otherSportsData.map((otherSingle) => (
                    <li
                        ...
                        <NoPrefetchLink href={otherSingle.href} className="d-flex align-items-center gap-2"><Image
                            width={16} height={16} src={otherSingle.image} alt="icon" />{otherSingle.linkText}</NoPrefetchLink>
